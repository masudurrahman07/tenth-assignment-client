    ...
    <div className="min-h-screen flex flex-col justify-center items-center text-center bg-gray-50 dark:bg-gray-950 px-4 transition-colors duration-300">
      ...
      <motion.div
        ...
        <p className="text-gray-500 dark:text-gray-400 text-lg mb-8 max-w-md mx-auto">
          The page you are looking for has been moved, deleted, or never existed in the first place.</p>

        
        <Link 
          to="/" 
          className="inline-block bg-blue-600 dark:bg-[#36e2c3] text-white dark:text-[#0b1a26] font-bold px-8 py-3 rounded-xl shadow-lg hover:opacity-90 transition-all transform hover:scale-105 active:scale-95">Go Back Home
        </Link>
      </motion.div>
    </div>
  );

    ...
    >
      ...
      <form onSubmit={handleAddJob} className="space-y-5">
        ...
        <textarea
          ...
          className="textarea textarea-bordered w-full focus:ring-2 focus:ring-blue-500 focus:border-blue-500 rounded-lg"
          rows={4}
          required
        />
        ...
        <motion.button
          ...
          whileTap={{ scale: 0.95 }}
          type="submit"
          className="bg-blue-500 hover:bg-blue-600 text-white font-semibold py-2 rounded-lg w-full shadow-md transition-all"
        >
          Add Job
        </motion.button>
      </form>

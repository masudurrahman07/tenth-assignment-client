...
const MyAcceptedTasks = () => {
  ...
  return (
    /* Wrapper added for full-page dark mode background */
              ...
              {jobs.map((job) => (
                ...
                >
                  ...
                  <p className="text-gray-600 dark:text-gray-400 text-sm mb-4 leading-relaxed">
                    {job.summary.length > 80 ? job.summary.slice(0, 80) + "..." : job.summary}
                  </p>
                  ...
                  <div className="flex gap-3">
                    ...
                    <motion.button
                      ...
                      className="bg-gray-100 dark:bg-gray-800 text-gray-700 dark:text-red-400 hover:bg-red-500 hover:text-white dark:hover:bg-red-600 dark:hover:text-white font-bold py-2 rounded-lg transition flex-1"
                    >
                      Cancel
                    </motion.button>
                  </div>
